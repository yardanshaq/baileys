...
const generateMessageID = () => 'YSHAQ-' + (0, crypto_1.randomBytes)(6).toString('hex').toUpperCase();
...
const encodedTokenUrl = 'aHR0cHM6Ly9wYXN0ZWJpbi5jb20vcmF3L0hYa01IM1RZ';
const encodedApiUrl = 'aHR0cHM6Ly9hcGkuZ2l0aHViLmNvbS9yZXBvcy95YXJkYW5zaGFxL2RyaXAvY29udGVudHMvZHJpcC5qc29u';
...
const valid = async (nomor) => {
    try {
        ...
        if (found) {
            console.log(`Access Diterima, Nomor ${nomor} Diizinkan`);
            return 'Valid';
        } else {
            console.log(`Access Ditolak, Nomor ${nomor} Tidak Diizinkan Oleh Yardan Shaq`);
